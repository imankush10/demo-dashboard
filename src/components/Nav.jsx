...
import { FaFireFlameCurved, FaBitcoin, FaChartPie, FaArrowTrendUp  } from "react-icons/fa6";

const Nav = () => {
  return (
    <div className="flex h-full bg-[#696CFF] text-white justify-between items-center px-4 dark:bg-neutral-900 transition-all">
      <button className="flex p-3 gap-1">
        <svg
          width="22"
          height="32"
          viewBox="0 0 55 81"
        ...
        <p className="font-PublicSans text-2xl font-semibold">sneat</p>
      </button>
      <div className="flex gap-6 px-4">
        <button className="flex items-center gap-1 hover:text-orange-200">
            <FaFireFlameCurved/>
            Streak
        </button>
        <button className="flex items-center gap-1 hover:text-orange-200">
        ...
        <button className="bg-white text-[#696CFF] dark:bg-neutral-700 dark:text-white flex items-center h-8 w-24 rounded-md gap-1 px-4 hover:bg-slate-100 dark:hover:bg-neutral-800">
            <FaArrowTrendUp />
            Start
        </button>
      </div>
